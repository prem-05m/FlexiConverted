...
/// @nodoc
mixin _$ImageTaskState {
  String get id => throw _privateConstructorUsedError;
  ImageToolType get toolType => throw _privateConstructorUsedError;
...
/// @nodoc
abstract class $ImageTaskStateCopyWith<$Res> {
  factory $ImageTaskStateCopyWith(
          ImageTaskState value, $Res Function(ImageTaskState) then) =
      _$ImageTaskStateCopyWithImpl<$Res, ImageTaskState>;
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class _$ImageTaskStateCopyWithImpl<$Res, $Val extends ImageTaskState>
    implements $ImageTaskStateCopyWith<$Res> {
  _$ImageTaskStateCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ImageTaskStateImplCopyWith<$Res>
    implements $ImageTaskStateCopyWith<$Res> {
  factory _$$ImageTaskStateImplCopyWith(_$ImageTaskStateImpl value,
          $Res Function(_$ImageTaskStateImpl) then) =
      __$$ImageTaskStateImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$$ImageTaskStateImplCopyWithImpl<$Res>
    extends _$ImageTaskStateCopyWithImpl<$Res, _$ImageTaskStateImpl>
    implements _$$ImageTaskStateImplCopyWith<$Res> {
  __$$ImageTaskStateImplCopyWithImpl(
      _$ImageTaskStateImpl _value, $Res Function(_$ImageTaskStateImpl) _then)
      : super(_value, _then);
...
class _$ImageTaskStateImpl implements _ImageTaskState {
  const _$ImageTaskStateImpl(
      {this.id = '',
      this.toolType = ImageToolType.convertFormat,
  ...
  _$$ImageTaskStateImplCopyWith<_$ImageTaskStateImpl> get copyWith =>
      __$$ImageTaskStateImplCopyWithImpl<_$ImageTaskStateImpl>(
          this, _$identity);
}

abstract class _ImageTaskState implements ImageTaskState {
  const factory _ImageTaskState(
      {final String id,
      final ImageToolType toolType,
...
class _$ImageResultImpl implements _ImageResult {
  ...
  @override
  String toString() {
    return 'ImageResult(outputPath: $outputPath, fileSizeBytes: $fileSizeBytes, durationMs: $durationMs)';
  }
...
abstract class _ImageResult implements ImageResult {
  const factory _ImageResult(
      ...
      required final int durationMs}) = _$ImageResultImpl;
