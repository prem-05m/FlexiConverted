...
class LocalAudioEngine implements AudioEngine {
  @override
  ...
  Future<EngineResponse<AudioResult>> convertFormat({
    ...
    return EngineResponse.notAvailable('Local Audio Conversion');
  }
  ...
  Future<EngineResponse<AudioResult>> compressAudio({
    ...
    return EngineResponse.notAvailable('Local Audio Compression');
  }
  ...
  Future<EngineResponse<AudioResult>> trimAudio({
    ...
    return EngineResponse.notAvailable('Local Audio Trim');
  }
  ...
  Future<EngineResponse<AudioResult>> mergeAudios({
    ...
    return EngineResponse.notAvailable('Local Audio Merge');
  }
  ...
  Future<EngineResponse<AudioResult>> normalizeVolume({
    ...
    return EngineResponse.notAvailable('Local Audio Normalize');
  }
  ...
  Future<EngineResponse<Map<String, dynamic>>> readMetadata({
    ...
    try {
      ...
      final duration = await player.setFilePath(inputPath);
